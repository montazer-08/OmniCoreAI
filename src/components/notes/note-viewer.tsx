...
import { BookText, Sparkles, ListTodo, Tags, Trash2 } from 'lucide-react';
    ...
    const handleSuggestKeywords = () => {
        ...
        startKeywordsTransition(async () => {
            try {
                ...
                toast({
                    variant: "destructive",
                    title: t.noteViewer.aiError,
                    description: t.noteViewer.keywordsErrorDescription,
                });
            }
        });
    };
        ...
        startTasksTransition(async () => {
            try {
                ...
                toast({
                    variant: "destructive",
                    title: t.noteViewer.aiError,
                    description: t.noteViewer.tasksErrorDescription,
                });
            }
        });
    };
